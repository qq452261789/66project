...
<html>
    ...
    <body>
    <a href="http://test.net/myFile/index.php/mypage/index" class="sale_btn">返回编辑</a>
    <a target = "_blank" href="http://test.net/myFile/index.php/mypage/index_publish" class="preview_btn">发布</a>
