...
<head lang="zh">
    ...
    <style>
        * {margin: 0; padding: 0;}
        ...
        .cell li{width: 120px;text-align: center;}
    </style>
    <script type="text/javascript" src="<?php echo base_url("static/js/jquery.js")?>"></script>
    <script type="text/javascript" src="<?php echo base_url("static/js/mytips.js")?>"></script>
</head>
<body>
<header style="text-align: center;font-weight: bold;font-size: 30px;line-height: 36px;">我的素材</header>
<div style="width: 100%;height:400px;margin-top: 10px;">
    <ul class="tabHeader">
        <li onclick="getdatas(1)" chids="ele1">图片</li><li onclick="getdatas(2)" chids="ele2">视频</li><li onclick="getdatas(3)" chids="ele3">音乐</li>
    </ul>
    <div id="tabContent"><?=$pic?></div>
</div>
<script type="text/javascript">
    $(function(){
        $("ul[class='tabHeader']>li").css("cursor","pointer");
        $("li[chids='ele1']").css("background","#00FFFF");
    });
    function getdatas(a){
        $(".tabHeader>li").not($("li[chids='ele"+a+"']")).removeClass("hover").css("background","#B0BABA");
        $($("li[chids='ele"+a+"']")).css("background","#00FFFF").addClass("hover");
        $("#tabContent").children().remove();
        $.ajax({
            type: "POST",
            url: "<?php echo site_url("Source/getSource"); ?>",
            data: "todo=save&typeid="+a,
        ...
        funsTool.showModbox('提交素材',240,400,function(){
            ...
            for(var i=0;i<len;i++){
                ...
                $.post(
                    ...
                    {"doaction":'ajaxUploadSomeImg',"data":datai,"namestr":namestri,"todo":"save","size":sizei},
                    function(datas){
                        _MSG+=datas;
