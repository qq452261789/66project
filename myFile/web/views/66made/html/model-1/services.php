...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("web/views/66made/css/model-1/services.css"); ?>">
        <style type="text/css">
    ...
    <body>
        ...
        <div id="header_box">
            <div id="header">
                <div id="log" class="left clearfix edit_text">
                    <a href="http://test.net/myFile/index.php/mypage/index_publish">
        ...
        <!-- service正文开始 -->
        <div id="service_content_box">
            <div class="service_content">
                <div class="service_title">
                    <h2 class="edit_text">服务</h2>
                    <div></div>
                ...
                <ul class="service_list clearfix">
                   <li class="left">
                       <div> 
                           <div class="service_img"><img class="edit_image" src="<?php echo base_url("web/views/66made/images/model-1/active/discuss_3.jpg"); ?>" alt="services" /></div>
                           <div class="service_list_text">
                               <p class="edit_text">企业战略</p>
                               <p class="edit_text">1 hr</p>
                               <p class="edit_text">在这里描述为您服务。是什么使得它的伟大？使用简短上口的文字告诉您提供什么人，他们将获得的利益。一个伟大的描述得到心情的读者，使他们更有可能继续和书籍。</p>
                           </div>
                       </div>
                       <button class="edit_text">立即预定</button>
                   </li>
                   <li>
                       <div>
                           <div class="service_img"><img class="edit_image" src="<?php echo base_url("web/views/66made/images/model-1/active/discuss_1.jpg"); ?>" /></div>
                           <div class="service_list_text">
                               <p class="edit_text">运营咨询</p>
                               <p class="edit_text">1 hr</p>
                               <p class="edit_text">在这里描述为您服务。是什么使得它的伟大？使用简短上口的文字告诉您提供什么人，他们将获得的利益。一个伟大的描述得到心情的读者，使他们更有可能继续和书籍。在这里描述为您服务。是什么使得它的伟大？使用简短上口的文字告诉您提供什么人，他们将获得的利益。一个伟大的描述得到心情的读者，使他们更有可能继续和书籍。在这里描述为您服务。是什么使得它的伟大？使用简短上口的文字告诉您提供什么人，他们将获得的利益。一个伟大的描述得到心情的读者，使他们更有可能继续和书籍。</p>
                           </div>
                       </div>
                       <button class="edit_text">立即预定</button>
                   </li>
                   <li class="right">
                       <div>
                           <div class="service_img"><img class="edit_image" src="<?php echo base_url("web/views/66made/images/model-1/active/working.jpg"); ?>" /></div>
                           <div class="service_list_text">
                               <p class="edit_text">项目管理</p>
                               <p class="edit_text">1 hr</p>
                               <p class="edit_text">在这里描述为您服务。是什么使得它的伟大？使用简短上口的文字告诉您提供什么人，他们将获得的利益。一个伟大的描述得到心情的读者，使他们更有可能继续和书籍。</p>
                           </div>
                       </div>
   ...
   $(function(){
        ...
        $(".save_btn").bind("click",function(){
            ...
            $.ajax({
                ...
                data: "modsid=1&content="+enmyhtml+"&pageid=6&title=1" ,
                datatype:"jsonp",
