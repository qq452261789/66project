...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="<?php echo site_url("Mods/addmod"); ?>" target="navTab"><span>添加</span></a></li>
            <li><a class="edit" href="<?php echo site_url("Mods/updateMod?id={admfun}"); ?>" target="navTab"><span>修改</span></a></li>
            <li><a class="delete" href="<?php echo site_url("Mods/deletemod?id={admfun}"); ?>" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
    ...
    <table layoutH="75" width="100%" class="table">
        ...
        <?php foreach ($list as $item): ?>
            <tr target="admfun" rel="<?=$item->id?>">
                ...
                <td class="ele"><?=$item->modname?></td>
                <td class="ele"><?=$item->modbody?></td>
                <td class="ele"><?=$item->modprice?></td>
                <td class="ele">
                    <?php if($item->modstate==0): ?>显示
                    <?php else:?>不显示
                    <?php endif;?>
                </td>
                <td class="ele">
