...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="<?php echo site_url("SourceType/addSourceType"); ?>" target="navTab" rel="admin_add"><span>添加</span></a></li>
            <li><a class="edit" href="<?php echo site_url("SourceType/updateSourceType?id={admrole}"); ?>" target="navTab"><span>修改</span></a></li>
            <li><a class="delete" href="<?php echo site_url("SourceType/deleteSourceType?id={admrole}"); ?>" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
